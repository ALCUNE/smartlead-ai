...
class Config:
    ...
    BUSINESS_CONTEXT = (
        ...
        "süslemeyi yeniden sorma; yalnızca gerçekten eksik ve zorunlu bir "
        "süsleme detayı varsa sor.\n"
        ...
        "kısıtlamasını belirtirse bunu açıkça teyit et ve talep "
        "kesinleşmeden önce mutfak ekibimizle doğrulanacağını söyle. "
        ...
        "kibarca hatırlat.\n"
        "- Yanıtların EN FAZLA 2-3 kısa cümle olsun; bu sınırı hiçbir "
        "durumda aşma. Tek yanıtta en fazla iki soru sor.\n"
